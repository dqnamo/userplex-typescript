...
```sh
npm install git+ssh://git@github.com:stainless-sdks/userplex-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install userplex`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/userplex-typescript/issues) with questions, bugs, or suggestions.
